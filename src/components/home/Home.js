  ...
  <main className="container m-auto px-8 justify-center items-center">
    <div className="flex flex-col-reverse sm:flex-row justify-between text-center py-16 ">
      <section className="sm:w-2/5 flex flex-col sm:items-start sm:text-left">
        ...
        <Link className="bg-blue-300 hover:bg-blue-500 py-3 px-6 uppercase text-lg font-bold text-white rounded-full" to="/projects">
          Projects <span>&#x25B6;</span>
        </Link>
      </section>
      <div className="flex flex-col items-center mb-16 sm:mb-0 mt-8 sm:mt-0 sm:w-3/5 sm:pl-12">
